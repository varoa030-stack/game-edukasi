...
export function Homepage() {
  ...
  const handleStart = (type: "materi" | "quiz") => {
    ...
    // Save user data
    localStorage.setItem("user", JSON.stringify({ name, kelas }));
    ...
    Admin
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
        ...
        <div className="space-y-6">
          ...
          <h1 className="text-5xl font-bold text-gray-800 leading-tight">
            Kenali <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600">Tubuhmu</span> dengan Cara Menyenangkan!
          </h1>
          
          <p className="text-lg text-gray-600">
            Belajar tentang bagian-bagian tubuh manusia melalui materi interaktif dan kuis yang seru. Cocok untuk siswa SD!
          </p>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-3xl shadow-lg space-y-4 border-2 border-purple-100">
            ...
            <div className="space-y-2">
              <Label htmlFor="kelas" className="text-gray-700">Kelas</Label>
              <Input
                id="kelas"
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-blue-100 to-blue-200 p-8 rounded-3xl shadow-lg border-2 border-blue-200 hover:scale-105 transition-transform">
          ...
          <h3 className="text-xl font-bold text-blue-900 mb-2">Materi Lengkap</h3>
          <p className="text-blue-700">Belajar tentang mata, telinga, tangan, kaki, dan bagian tubuh lainnya</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-100 to-purple-200 p-8 rounded-3xl shadow-lg border-2 border-purple-200 hover:scale-105 transition-transform">
          ...
          <h3 className="text-xl font-bold text-purple-900 mb-2">2 Level Kuis</h3>
          <p className="text-purple-700">Tebak gambar dan kuis pemahaman yang seru!</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-orange-100 to-orange-200 p-8 rounded-3xl shadow-lg border-2 border-orange-200 hover:scale-105 transition-transform">
          ...
          <h3 className="text-xl font-bold text-orange-900 mb-2">Peringkat</h3>
          <p className="text-orange-700">Lihat skormu dan bandingkan dengan teman-teman!</p>
        </div>
      </div>
    </div>
  );
